package ruina.shaders.FrostSplinter;
...
public class FrostSplinterPostProcessor implements ScreenPostProcessor {

    private static final String VERTEX_PATH = makeShaderPath("FrostSplinter/vertex.vs");
    private static final String FRAGMENT_PATH = makeShaderPath("FrostSplinter/fragment.fs");
