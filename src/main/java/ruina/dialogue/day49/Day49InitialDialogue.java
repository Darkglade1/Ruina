...
import ruina.dialogue.speaker.day49.ts_Angela_LOB;
...
public class Day49InitialDialogue extends AbstractGameEffect {
    public static final String ID = Day49InitialDialogue.class.getSimpleName();
