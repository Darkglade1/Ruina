...
public class Erosion extends AbstractEasyPower {
    public static final String POWER_ID = RuinaMod.makeID("Erosion");
    ...
    public Erosion(AbstractCreature owner, int amount) {
