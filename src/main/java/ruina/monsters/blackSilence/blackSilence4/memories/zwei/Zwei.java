...
@AutoAdd.Ignore
public class Zwei extends AbstractRuinaCard {
    public final static String ID = makeID(Zwei.class.getSimpleName());
    BlackSilence4 parent;

    public Zwei(BlackSilence4 parent) {
        ...
        this.parent = parent;
        magicNumber = baseMagicNumber = parent.zweiMetallicize;
        secondMagicNumber = baseSecondMagicNumber = parent.zweiArmor;
    }
