package ruina.monsters.angela.Abnormalities.KnightOfDespair;
...
public class AngelaKnightOfDespair extends AbnormalityContainer
{
    public static final String ABNOID = "KnightOfDespair";
    public static final String WARNING = "WAW";
    public static final String ID = makeID(AngelaKnightOfDespair.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);
    public static final String NAME = monsterStrings.NAME;
    private static final byte NONE = 0;
    public AngelaKnightOfDespair(){
        this(0, 275);
    }
    public AngelaKnightOfDespair(final float x, final float y) {
