...
public class AngelaRoadHome extends AbnormalityContainer
{
    public static final String ABNOID = "RoadHome";
    public static final String WARNING = "HE";
    public static final String ID = makeID(AngelaRoadHome.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);
    public static final String NAME = monsterStrings.NAME;
    private static final byte NONE = 0;
    public AngelaRoadHome(){
        this(0, 275);
    }
    public AngelaRoadHome(final float x, final float y) {
