package ruina.monsters.angela.Abnormalities.TrainingDummy;
...
public class AngelaTrainingDummy extends AbnormalityContainer
{
    public static final String ABNOID = "Dummy";
    public static final String WARNING = "TETH";
    public static final String ID = makeID(AngelaTrainingDummy.class.getSimpleName());
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);
    public static final String NAME = monsterStrings.NAME;
    private static final byte NONE = 0;
    public AngelaTrainingDummy(){
        this(0, 275);
    }
    public AngelaTrainingDummy(final float x, final float y) {
