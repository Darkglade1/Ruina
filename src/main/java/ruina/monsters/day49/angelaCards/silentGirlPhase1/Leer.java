...
@AutoAdd.Ignore
public class Leer extends AbstractRuinaCard {
    public final static String ID = makeID(Leer.class.getSimpleName());
    private Act5Angela parent;

    public Leer(Act5Angela parent) {
        super(ID, 3, CardType.SKILL, CardRarity.RARE, CardTarget.ENEMY, RuinaMod.Enums.EGO);
        magicNumber = baseMagicNumber = parent.leerParalysis;
        secondMagicNumber = baseSecondMagicNumber = parent.leerStrength;
        this.parent = parent;
    }
    ...
    @Override
    public AbstractCard makeCopy() { return new Leer(parent); }
}