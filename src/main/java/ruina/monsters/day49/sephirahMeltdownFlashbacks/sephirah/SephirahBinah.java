...
public class SephirahBinah extends AbstractRuinaMonster
{
    public static final String ID = makeID(SephirahBinah.class.getSimpleName());
    ...
    public SephirahBinah() {
        this(0.0f, 0.0f);
    }

    public SephirahBinah(final float x, final float y) {
        super(NAME, ID, 140, 0.0F, 0, 220.0f, 320.0f, null, x, y);
        loadAnimation(makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Binah/binah.atlas"), makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Binah/binah.json"), 1F);
