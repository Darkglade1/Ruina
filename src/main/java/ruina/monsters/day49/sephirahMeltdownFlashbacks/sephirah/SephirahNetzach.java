...
public class SephirahNetzach extends AbstractRuinaMonster
{
    public static final String ID = makeID(SephirahNetzach.class.getSimpleName());
    ...
    public SephirahNetzach() {
        this(0.0f, 0.0f);
    }

    public SephirahNetzach(final float x, final float y) {
        super(NAME, ID, 140, 0.0F, 0, 220.0f, 320.0f, null, x, y);
        loadAnimation(makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Netzach/netzach.atlas"), makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Netzach/netzach.json"), 1F);
