...
public class SephirahYesod extends AbstractRuinaMonster
{
    ...
    public SephirahYesod(final float x, final float y) {
        ...
        loadAnimation(makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Yesod/yesod.atlas"), makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Yesod/yesod.json"), 1.6F);
