...
public class SephirahGebura extends AbstractRuinaMonster
{
    public static final String ID = makeID(SephirahGebura.class.getSimpleName());
    ...
    public SephirahGebura() {
        this(0.0f, 0.0f);
    }

    public SephirahGebura(final float x, final float y) {
        super(NAME, ID, 140, 0.0F, 0, 220.0f, 320.0f, null, x, y);
        loadAnimation(makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Gebura/gebura.atlas"), makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Gebura/gebura.json"), 1F);
