...
public class SephirahTiphereth extends AbstractRuinaMonster
{
    public static final String ID = makeID(SephirahTiphereth.class.getSimpleName());
    ...
    public SephirahTiphereth() {
        this(-450.0f, 0.0f);
    }

    public SephirahTiphereth(final float x, final float y) {
        super(NAME, ID, 140, 0.0F, 0, 220.0f, 320.0f, null, x, y);
        loadAnimation(makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Tiphereth/tiphereth.atlas"), makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Tiphereth/tiphereth.json"), 0.65f);
