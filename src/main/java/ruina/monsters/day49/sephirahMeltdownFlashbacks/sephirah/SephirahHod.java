...
public class SephirahHod extends AbstractRuinaMonster
{
    public static final String ID = makeID(SephirahHod.class.getSimpleName());
    ...
    public SephirahHod(final float x, final float y) {
        super(NAME, ID, 140, 0.0F, 0, 220.0f, 320.0f, null, x, y);
        loadAnimation(makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Hod/hod.atlas"), makeMonsterPath("Day49/SephirahMeltdownFlashbacks/Hod/hod.json"), 1F);
