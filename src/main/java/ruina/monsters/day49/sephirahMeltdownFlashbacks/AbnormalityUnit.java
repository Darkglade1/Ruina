...
public class AbnormalityUnit extends AbstractRuinaMonster
{
    ...
    public AbnormalityUnit(String ABNOID) { this(0.0f, 275f, ABNOID); }
    public AbnormalityUnit(final float x, final float y, String ABNOID) {
        super(NAME, ID, 20, -5.0F, 0, 130.0f, 125.0f, null, x, y);
        this.animation = new BetterSpriterAnimation(makeMonsterPath("Day49/AbnormalityContainer/AbnormalityUnit/Spriter/AbnormalityUnit.scml"));
