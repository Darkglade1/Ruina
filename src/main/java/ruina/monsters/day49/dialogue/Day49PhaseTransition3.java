...
public class Day49PhaseTransition3 extends AbstractGameEffect {
    public static final String ID = Day49PhaseTransition3.class.getSimpleName();
    ...
    private final TextureRegion AYIN_BG;
    ...
    public Day49PhaseTransition3(int start, int end) {
        Texture AYIN_TEXTURE = TexLoader.getTexture(RuinaMod.makeUIPath("day49Panel4.png"));
        AYIN_BG = new TextureRegion(AYIN_TEXTURE);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(AYIN_BG, 0.0F, 0.0F, 0.0f, 0.0f, AYIN_BG.getRegionWidth(), AYIN_BG.getRegionHeight(), Settings.scale, Settings.scale, 0.0f);
