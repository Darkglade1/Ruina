...
public class Day49PhaseTransition2 extends AbstractGameEffect {
    public static final String ID = Day49PhaseTransition2.class.getSimpleName();
    ...
    private final TextureRegion CARMEN_BG;
    ...
    public Day49PhaseTransition2(int start, int end) {
        Texture CARMEN_TEXTURE = TexLoader.getTexture(RuinaMod.makeUIPath("day49Panel3.png"));
        CARMEN_BG = new TextureRegion(CARMEN_TEXTURE);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(CARMEN_BG, 0.0F, 0.0F, 0.0f, 0.0f, CARMEN_BG.getRegionWidth(), CARMEN_BG.getRegionHeight(), Settings.scale, Settings.scale, 0.0f);
