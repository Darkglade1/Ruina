...
public class Day49PhaseTransition5 extends AbstractGameEffect {
    public static final String ID = Day49PhaseTransition5.class.getSimpleName();
    ...
    private final TextureRegion ANGELA_BG;
    ...
    public Day49PhaseTransition5(int start, int end, Act5Angela source) {
        Texture ANGELA_TEXTURE = TexLoader.getTexture(RuinaMod.makeUIPath("day49Panel5a.png"));
