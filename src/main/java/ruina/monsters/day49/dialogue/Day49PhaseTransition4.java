...
public class Day49PhaseTransition4 extends AbstractGameEffect {
    public static final String ID = Day49PhaseTransition4.class.getSimpleName();
    ...
    public Day49PhaseTransition4(int start, int end) {
        Texture ANGELA_TEXTURE = TexLoader.getTexture(RuinaMod.makeUIPath("day49Panel5.png"));
