...
public class Day49PhaseTransition1 extends AbstractGameEffect {
    public static final String ID = Day49PhaseTransition1.class.getSimpleName();
    ...
    public Day49PhaseTransition1(int start, int end) {
        Texture BLOODBATH_TEXTURE = TexLoader.getTexture(RuinaMod.makeUIPath("day49Panel2.png"));
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(BLOODBATH_BG, 0.0F, 0.0F, 0.0f, 0.0f, BLOODBATH_BG.getRegionWidth(), BLOODBATH_BG.getRegionHeight(), Settings.scale, Settings.scale, 0.0f);
