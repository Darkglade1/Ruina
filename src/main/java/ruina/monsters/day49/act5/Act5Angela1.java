...
public class Act5Angela1 extends AbstractCardMonster
{
    ...
    protected void getMove(final int num) {
        ...
        else if (turnCounter == 2) { setMoveShortcut(COLLAPSING_HEART, MOVES[COLLAPSING_HEART], cardList.get(COLLAPSING_HEART)); }
        else { setMoveShortcut(CRACKED_HEART, MOVES[CRACKED_HEART], cardList.get(CRACKED_HEART)); }
    }
