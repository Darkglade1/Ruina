package ruina.monsters.eventBoss.core.ui;
...
import ruina.monsters.eventBoss.core.vfx.EnemyRefreshEnergyEffect;
...
public class EnemyEnergyPanel extends AbstractPanel {
    ...
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(makeID("EnergyPanelTip"));
    ...
    private AbstractRuinaCardMonster owner;

    public EnemyEnergyPanel(AbstractRuinaCardMonster owner) {
    ...
    public static void addEnergy(final int e) {
        ...
        if (EnemyEnergyPanel.totalCount >= 9) { UnlockTracker.unlockAchievement("ADRENALINE"); }
    ...
    public void render(final SpriteBatch sb) {
        ...
        if (this.tipHitbox.hovered && AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT && !AbstractDungeon.isScreenUp) { TipHelper.renderGenericTip(1550.0F * Settings.scale, 750.0F * Settings.scale, EnemyEnergyPanel.LABEL[0], EnemyEnergyPanel.MSG[0]); }
    }
