...
public abstract class AbstractRuinaBossCard extends AbstractCard {
    ...
    public void hover() {
        ...
        if (!this.hov2) {
            ...
            this.targetDrawScale = AbstractRuinaBossCard.HOVER_SCALE;
            this.drawScale = AbstractRuinaBossCard.HOVER_SCALE;
        }
    }
    ...
    public void unhover() {
        ...
        if (this.hov2) {
            ...
            AbstractRuinaCardMonster.boss.hand.refreshHandLayout();
            this.targetDrawScale = AbstractRuinaBossCard.HAND_SCALE;
        }
    }
