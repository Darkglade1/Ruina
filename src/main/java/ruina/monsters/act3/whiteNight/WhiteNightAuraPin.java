...
public class WhiteNightAuraPin extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(WhiteNightAura.AuraPin, this.x, this.y - WhiteNightAura.AuraPin.packedHeight / 2.0F , 0.0F, WhiteNightAura.AuraPin.packedHeight / 2.0F, WhiteNightAura.AuraPin.packedWidth, WhiteNightAura.AuraPin.packedHeight, this.scale * this.scaX * Settings.scale, this.scale * this.scaY * Settings.scale, this.rotation);
