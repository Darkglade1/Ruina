...
@AutoAdd.Ignore
public class ThinLine extends AbstractRuinaCard {
    public final static String ID = makeID(ThinLine.class.getSimpleName());
    private Zena parent;
    ...
    @Override
    public AbstractCard makeCopy() { return new ThinLine(parent); }
}