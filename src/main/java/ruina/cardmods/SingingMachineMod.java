...
public class SingingMachineMod extends AbstractCardModifier {

    public static final String ID = RuinaMod.makeID("SingingMachineMod");

    public static final String STRING = RuinaMod.makeMonsterPath("SingingMachine/SingingMachineMod.png");
